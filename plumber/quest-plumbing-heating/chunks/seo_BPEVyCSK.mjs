...
const site = {
  businessName: "Quest Plumbing & Heating",
  tagline: "Professional Plumber Service in Troy",
  description: "Quest Plumbing & Heating provides quality plumber services in Troy, NY. Licensed, insured, and locally trusted.",
  phone: "+1 518-663-5280",
  email: "contact@quest-plumbing-heating.com",
  address: "Serving Troy, NY",
  city: "Troy",
  region: "NY",
  niche: "plumber",
  template: templateForNiche("plumber"),
  slug: "quest-plumbing-heating",
  url: "https://pmb2.github.io/generated-websites/plumber/quest-plumbing-heating/",
  latitude: 42.726,
  longitude: -73.688,
  rating: 4.8,
  reviewCount: 18,
  ...
  reviews: [
    { name: "Michael R.", rating: 5, text: "Called Quest Plumbing & Hea for plumber service. They were at my door within an hour.", date: "2026-06-20" },
