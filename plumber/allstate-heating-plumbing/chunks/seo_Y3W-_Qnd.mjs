...
const site = {
  businessName: "Allstate Heating & Plumbing",
  tagline: "Professional Plumber Service in Troy",
  description: "Allstate Heating & Plumbing provides quality plumber services in Troy, NY. Licensed, insured, and locally trusted.",
  phone: "+1 518-274-2146",
  email: "contact@allstate-heating-plumbing.com",
  address: "Serving Troy, NY",
  city: "Troy",
  region: "NY",
  niche: "plumber",
  template: templateForNiche("plumber"),
  slug: "allstate-heating-plumbing",
  url: "https://pmb2.github.io/generated-websites/plumber/allstate-heating-plumbing/",
  latitude: 42.728,
  longitude: -73.692,
  rating: 4.5,
  reviewCount: 22,
  ...
  reviews: [
    { name: "Michael R.", rating: 5, text: "Called Allstate Heating & P for plumber service. They were at my door within an hour.", date: "2026-06-20" },
