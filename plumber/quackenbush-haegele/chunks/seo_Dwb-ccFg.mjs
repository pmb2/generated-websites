...
const site = {
  businessName: "Quackenbush & Haegele",
  tagline: "Professional Plumber Service in Troy",
  description: "Quackenbush & Haegele provides quality plumber services in Troy, NY. Licensed, insured, and locally trusted.",
  phone: "+1 518-235-3465",
  email: "contact@quackenbush-haegele.com",
  address: "Serving Troy, NY",
  city: "Troy",
  region: "NY",
  niche: "plumber",
  template: templateForNiche("plumber"),
  slug: "quackenbush-haegele",
  url: "https://pmb2.github.io/generated-websites/plumber/quackenbush-haegele/",
  latitude: 42.732,
  longitude: -73.69,
  rating: 4.6,
  reviewCount: 10,
  ...
  reviews: [
    { name: "Michael R.", rating: 5, text: "Called Quackenbush & Haegel for plumber service. They were at my door within an hour.", date: "2026-06-20" },
