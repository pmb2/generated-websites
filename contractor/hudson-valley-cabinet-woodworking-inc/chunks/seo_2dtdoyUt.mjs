...
const site = {
  businessName: "Hudson Valley Cabinet & Woodworking Inc",
  tagline: "Professional Contractor Service in Hudson",
  description: "Hudson Valley Cabinet & Woodworking Inc provides quality contractor services in Hudson, NY. Licensed, insured, and locally trusted.",
  phone: "+1 518-828-4500",
  email: "contact@hudson-valley-cabinet-woodworking-inc.com",
  address: "Serving Hudson Valley, NY",
  city: "Hudson",
  region: "NY",
  niche: "contractor",
  template: templateForNiche("contractor"),
  slug: "hudson-valley-cabinet-woodworking-inc",
  url: "https://pmb2.github.io/generated-websites/contractor/hudson-valley-cabinet-woodworking-inc/",
  latitude: 42.252,
  longitude: -73.791,
  rating: 4.5,
  reviewCount: 12,
  ...
  galleryImages: [],
  services: [{ slug: "remodeling", title: "Remodeling", description: "Professional remodeling services." }, { slug: "additions", title: "Additions", description: "Professional additions services." }, { slug: "basement-finishing", title: "Basement Finishing", description: "Professional basement finishing services." }, { slug: "deck-building", title: "Deck Building", description: "Professional deck building services." }, { slug: "foundation", title: "Foundation", description: "Professional foundation services." }, { slug: "general-contracting", title: "General Contracting", description: "Professional general contracting services." }],
  reviews: [
    { name: "Michael R.", rating: 5, text: "Called Hudson Valley Cabine for contractor service. They were at my door within an hour.", date: "2026-06-20" },
    { name: "Sarah L.", rating: 5, text: "Professional, courteous, and fair priced. Will definitely call again.", date: "2026-05-15" },
    { name: "Robert K.", rating: 4, text: "Great contractor company. Showed up on time and delivered quality work.", date: "2026-04-28" }
  ],
  faqs: [
    ...
    { q: "What areas do you serve?", a: "We serve Hudson, NY and surrounding communities." },
