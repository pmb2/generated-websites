...
const site = {
  businessName: "Friendly Painters",
  tagline: "Professional Painter Service in Albany",
  description: "Friendly Painters provides quality painter services in Albany, NY. Licensed, insured, and locally trusted.",
  phone: "(518) 379-6182",
  email: "contact@friendly-painters.com",
  address: "Serving Albany and Surrounding Areas",
  city: "Albany",
  region: "NY",
  niche: "painter",
  template: templateForNiche("painter"),
  slug: "friendly-painters",
  url: "https://pmb2.github.io/generated-websites/painter/friendly-painters/",
  latitude: 42.652,
  longitude: -73.756,
  rating: 4.6,
  reviewCount: 16,
  ...
  galleryImages: [],
  services: [{ slug: "interior-painting", title: "Interior Painting", description: "Professional interior painting services." }, { slug: "exterior-painting", title: "Exterior Painting", description: "Professional exterior painting services." }, { slug: "cabinet-painting", title: "Cabinet Painting", description: "Professional cabinet painting services." }, { slug: "deck-staining", title: "Deck Staining", description: "Professional deck staining services." }, { slug: "drywall-repair", title: "Drywall Repair", description: "Professional drywall repair services." }, { slug: "commercial-painting", title: "Commercial Painting", description: "Professional commercial painting services." }],
  reviews: [
    { name: "Michael R.", rating: 5, text: "Called Friendly Painters for painter service. They were at my door within an hour.", date: "2026-06-20" },
    { name: "Sarah L.", rating: 5, text: "Professional, courteous, and fair priced. Will definitely call again.", date: "2026-05-15" },
    { name: "Robert K.", rating: 4, text: "Great painter company. Showed up on time and delivered quality work.", date: "2026-04-28" }
  ],
  faqs: [
    ...
    { q: "What areas do you serve?", a: "We serve Albany, NY and surrounding communities." },
